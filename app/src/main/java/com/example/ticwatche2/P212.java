...
public class P212 extends WearableActivity {

    private Button p212o;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p212);
        ...
        p212o = findViewById(R.id.p212o);
        p212o.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void countDownTimer(long millisInFuture) {
        countDownTimer= new CountDownTimer(millisInFuture, 1000) {
            public void onTick(long millisUntilFinished) {
                ...
                Log.d("212CountDownTime", String.valueOf(countDownTime));
            }
