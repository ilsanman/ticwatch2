...
public class P122 extends WearableActivity {

    private Button p122o;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p122);
        ...
        p122o = findViewById(R.id.p122o);
        p122o.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void countDownTimer(long millisInFuture) {
        countDownTimer= new CountDownTimer(millisInFuture, 1000) {
            public void onTick(long millisUntilFinished) {
                ...
                Log.d("122CountDownTime", String.valueOf(countDownTime));
            }
